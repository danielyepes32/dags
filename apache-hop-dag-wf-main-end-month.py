...
schedule_interval = Variable.get("schedule_interval_WF_MAIN_END_MONTH", default_var="0 14 1 * *")

with DAG('WF_MAIN_END_MONTH', 
    ...
    hop = DockerOperator(
        ...
        environment={
            'HOP_LOG_LEVEL': 'Basic',
            'HOP_FILE_PATH': '${PROJECT_HOME}/workflows/WF_MAIN_END_MONTH.hwf',
