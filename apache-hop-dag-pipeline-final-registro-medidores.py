...
default_args = {
    'owner': 'airflow',
    'description': 'REGISTRO_MEDIDORES',
...
schedule_interval = Variable.get("schedule_interval_REGISTRO_MEDIDORES", default_var="0 15 1 * *")

with DAG('REGISTRO_MEDIDORES', 
    ...
    hop = DockerOperator(
        ...
        environment={
            'HOP_LOG_LEVEL': 'Basic',
            'HOP_FILE_PATH': '${PROJECT_HOME}/Pipelines/FINAL_REGISTRO_MEDIDORES.hpl',
        ...
        network_mode='bridge',
        mounts=[
            Mount(source='C:/Users/danie/OneDrive/Documentos/work_projects/medileser/aplicativoSmart/backSmart/ProyectoSmartMed', target='/files', type='bind'),
        ],
